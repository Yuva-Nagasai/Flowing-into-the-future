...
# Create .env file (see server/BACKEND_README.md for details)
...
- See `server/BACKEND_README.md` for complete list
...
npm start
```
Deploy the `server/` directory to your server. Make sure to:
...
- **Backend**: See `server/BACKEND_README.md`
- **API Endpoints**: See `server/BACKEND_README.md` for complete API documentation
