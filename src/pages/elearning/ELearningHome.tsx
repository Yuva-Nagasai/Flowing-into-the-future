        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
            <div>
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  ...
                  <p className={`text-xs ${theme === 'dark' ? 'text-electric-green' : 'text-accent-red'}`}>
                    Academy
                  </p>
                </div>
              </div>
            ...
            {[
              ...
              {
                title: 'Categories',
                links: ['Web Development', 'Data Science', 'AI & ML', 'Mobile Dev']
              },
              {
                title: 'Support',
                links: ['Help Center', 'Terms', 'Privacy', 'FAQ']
              }
            ].map((col, idx) => (
              <div key={idx}>
