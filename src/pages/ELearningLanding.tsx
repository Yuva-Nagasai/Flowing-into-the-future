                  ...
                  {filteredCourses.map((course) => (
                    <motion.div
                      ...
                      className={`group cursor-pointer p-6 rounded-2xl transition-all ${
                        theme === 'dark'
                          ? 'bg-dark-card border border-gray-800 hover:border-electric-blue/50 hover:shadow-xl hover:shadow-electric-blue/10'
                          : 'bg-white border border-gray-200 hover:border-accent-blue/50 hover:shadow-xl hover:shadow-accent-blue/10'
                      }`}
                    >
                      {/* Thumbnail */}
