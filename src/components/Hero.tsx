...
const Hero = () => {
  ...
  className={`max-w-xs md:max-w-sm rounded-lg shadow-lg ${imageSlideInClass} mx-auto md:mx-0`}
  style={{
    display: 'block',
    marginBottom: '1.5rem', // adds space below the image
    marginTop: '-4rem',   // moves the image slightly up
  }}
/>
